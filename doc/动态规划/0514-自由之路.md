...
**原链接**：<https://leetcode-cn.com/problems/freedom-trail/>

#### 深度优先搜索[Depth-first Search]    分治算法[Divide and Conquer]    动态规划[Dynamic Programming]    
...
<center><img src="../../static/2018/10/22/ring.jpg" style="width: 26%;" /></center>
&nbsp;
