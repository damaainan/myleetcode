...
**原链接**：<https://leetcode-cn.com/problems/find-eventual-safe-states/>

#### 深度优先搜索[Depth-first Search]    图[Graph]    
...
<p><img alt="Illustration of graph" src="../../static/2018/03/17/picture1.png" style="height:86px; width:300px" /></p>
