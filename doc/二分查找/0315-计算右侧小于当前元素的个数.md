...
**原链接**：<https://leetcode-cn.com/problems/count-of-smaller-numbers-after-self/>

#### 排序[Sort]    树状数组[Binary Indexed Tree]    线段树[Segment Tree]    二分查找[Binary Search]    分治算法[Divide and Conquer]    
