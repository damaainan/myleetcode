...
**原链接**：<https://leetcode-cn.com/problems/minimum-moves-to-reach-target-with-rotations/>
...
<ul>
	...
	<img alt="" src="../../static/2019/09/24/image-2.png" style="width: 300px; height: 134px;" /></li>
	...
	<img alt="" src="../../static/2019/09/24/image-1.png" style="width: 300px; height: 121px;" /></li>
</ul>
...
<p><strong><img alt="" src="../../static/2019/09/24/image.png" style="width: 400px; height: 439px;" /></strong></p>
...
<ul>
	...
	<img alt="" src="../../static/2019/09/28/image-2.png" style="height: 134px; width: 300px;"></li>
	<li>如果它处于竖直状态并且其右面的两个单元都是空的，就逆时针旋转 90 度。蛇从（<code>(r, c)</code>、<code>(r+1, c)</code>）移动到（<code>(r, c)</code>、<code>(r, c+1)</code>）。<br>
	<img alt="" src="../../static/2019/09/28/image-1.png" style="height: 121px; width: 300px;"></li>
</ul>
...
<p><strong><img alt="" src="../../static/2019/09/28/image.png" style="height: 439px; width: 400px;"></strong></p>
